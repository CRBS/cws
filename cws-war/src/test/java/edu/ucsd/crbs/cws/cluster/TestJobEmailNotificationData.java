...
public class TestJobEmailNotificationData {

    public TestJobEmailNotificationData() {
    }
    ...
    public void testGetterAndSetter(){
        JobEmailNotificationData jend = new JobEmailNotificationData();
        
        //bcc is empty string if set to null
        assertTrue(jend.getBccEmail().equals(""));
        assertTrue(jend.getHelpEmail() == null);
