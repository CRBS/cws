...
/**
 * Creates MultivaluedMap with authentication query parameters
 * already added
 * @author Christopher Churas <churas@ncmir.ucsd.edu>
 */
public class MultivaluedMapFactoryImpl implements MultivaluedMapFactory {

    
    @Override
    public MultivaluedMap getMultivaluedMap(User u) {
