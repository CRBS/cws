...
public interface WorkflowFailedWriter {
    ...
    /**
     * Sets directory to write failed file to
     * @param path
     * @throws Exception 
     */
    ...
    /**
     * Writes <b>error</b> and <b>detailedError</b> to failed file
     * @param error
     * @param detailedError
     * @throws Exception 
     */
    public void write(final String error, final String detailedError) throws Exception;
