...
public class Event {
    ...
    /**
     * Logical deletion of a WorkspaceFile
     */
    public static final String LOGICAL_DELETE_WORKSPACEFILE_EVENT_TYPE = "logicaldeleteworkspacefile";
    
    /**
     * Deletion of a WorkspaceFile
     */
