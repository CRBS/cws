...
public class URLFetcherImpl implements URLFetcher {
     ...
     * <p/>
     * ${logintorunas} -- Any instances of this in URL will be replaced with the runasuser query parameter value
     * <p/>
     * ${requestorip} -- Any instances of this in URL will be replaced with requestors ip address
     * <p/>
     * 
     * @param parameter
     * @throws Exception 
