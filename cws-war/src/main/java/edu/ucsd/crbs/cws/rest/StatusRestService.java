...
import edu.ucsd.crbs.cws.log.ServiceStatus;
...
/**
 * Rest end point to provide status information about application
 * 
 * @author Christopher Churas <churas@ncmir.ucsd.edu>
 */
@Path(Constants.SLASH+Constants.STATUS_PATH)
public class StatusRestService {
    ...
    public ServiceStatus getStatus(@Context HttpServletRequest request) {
        
        CapabilitiesService service =
        CapabilitiesServiceFactory.getCapabilitiesService();
        
        return new ServiceStatus(service);
    }
