...
echo "java -jar cws-war/target/cws-war-1.18-SNAPSHOT-jar-with-dependencies.jar --uploadwf cws-war/src/test/resources/example.kar --url ${baseURL} --login ${user} --token ${token}"

echo ""
echo ""
echo "Add a file to workspace"
echo "java -jar cws-war/target/cws-war-1.18-SNAPSHOT-jar-with-dependencies.jar --uploadfile cws-war/src/test/resources/example.kar --url ${baseURL} --login ${user} --token ${token}"
echo ""
echo ""
